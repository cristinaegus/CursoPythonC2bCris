...
class Coche:
    ...
    def __del__(self):
        print(f"El coche {self.marca} {self.modelo} se está borrando de la memoria")

    def presentarse(self):
        print(f"Hola, soy un coche de marca {self.marca}, modelo {self.modelo}, "
              f"tengo una longitud de {self.longitud} metros y un precio de {self.precio} euros.")
...
Coche(marca="Renault", modelo="Megane", longitud=3.5, precio=3000)
...
# Para comparar los coches por el precio, podemos definir el método __gt__ (mayor que)
# que se llama cuando usamos el operador > entre dos objetos de la clase Coche.
# def __gt__(sel
# if coche1 > coche2:
#   pass
