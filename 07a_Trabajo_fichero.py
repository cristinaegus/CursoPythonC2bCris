...
# y permite crear, eliminar, mover y renombrar archivos y carpetas.
# sys es una librería que permite interactuar con el intérprete de Python
# y permite acceder a variables y funciones que controlan el intérprete.
# sys.path es una lista de cadenas que especifica las rutas de búsqueda para
...
import funciones.circulo as cir
...
libro = libro.replace("\n", " ")
print(libro[5000:6000])
# esto es para limpiar el texto del libro y que aparacecan saltos de lineas 
libro = libro.replace("\n\n", "Salt0Renglon")
# esto limpia el texto de salto de renglon
libro[5000:6000]
libro = libro.replace("\n", " ")
libro[5000:6000]
