...
# tupla_mixta[0] = 2  # Esto da error porque las tuplas son inmutables
tupla_mixta = list(tupla_mixta)
tupla_mixta[0] = 2
tupla_mixta.sort()  # Ordena la lista
tupla_mixta = tuple(tupla_mixta)
tupla_mixta.sort()
